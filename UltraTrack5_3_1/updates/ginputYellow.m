...
%*************** CHANGED [1,1,1] TO [1,1,0] to make cross hairs yellow ******************
for k = 1:4
    crossHair(k) = uicontrol(fig, 'Style', 'text', 'Visible', 'off', 'Units', 'pixels', 'BackgroundColor', [1 1 0], 'HandleVisibility', 'off', 'HitTest', 'off'); %#ok<AGROW>
end
end
