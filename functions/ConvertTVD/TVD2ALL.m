...
TVDdata.maxTime = cmd.GetCurrentFrameTime() / 1000; %/1000 because in ms, first frame time is 0.
TVDdata.fps = round(1/(TVDdata.maxTime / TVDdata.Fnum),3);
% Go to first frame
...
rect = [minX, top, width, abs(top-bot)];
TVDdata.rect = rect;
%% OLD method
